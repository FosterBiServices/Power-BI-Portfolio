-- Get results of every possible combination of columns chosen 
...
GROUP BY CUBE(D.FiscalPeriodNameLong), C.BusinessGroup
...
JOIN NADCS_DW.dbo.dim_date D ON C.date_ID = D.Date_ID
WHERE D.FiscalPeriodNameLong IN ('FY17 P10', 'FY17 P11')
GROUP BY D.FiscalPeriodNameLong, C.BusinessGroup with CUBE
